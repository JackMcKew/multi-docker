This repository will be going through how to develop & deploy a multi-container application onto AWS Elastic Beanstalk. The full write up is available over on: <https://github.com/JackMcKew/jackmckew.dev/blob/drafts/drafts/2020/develop-and-deploy-with-docker-compose/develop-and-deploy-with-docker-compose.md>
